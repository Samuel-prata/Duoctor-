...
import com.duoctor.duoctor.repository.UsuarioRepository;
import com.duoctor.duoctor.service.UsuarioService;
...
public class UsuarioControllerTest {
	...
	public void naoDeveDuplicarUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, 
			"Maria da Silva", "maria_silva@email.com.br", "13465278", "https://i.imgur.com/T12NIp9.jpg", "remedio"));
